...
class SecurityServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        // Reset SecurityContextHolder to ensure clean state for each test
    ...
    void givenLoggedInUser_whenFindLoggedInUsername_thenReturnUsername() {
        // Arrange
    ...
    void givenNoLoggedInUser_whenFindLoggedInUsername_thenReturnNull() {
        // Arrange
        when(SecurityContextHolder.getContext()).thenReturn(securityContext);
    ...
    void givenValidCredentials_whenAutologin_thenSetAuthenticationInSecurityContext() {
        ...
        // Simulate successful authentication by setting authenticated flag on the token
        // Since we can't easily mock the internal state of UsernamePasswordAuthenticationToken,
        // we verify that authenticationManager.authenticate is called and securityContext.setAuthentication is called
